...
type IconOptions = 'material' | 'painted';


 export const IconThemeOptions = ({ 
        mode, 
        icon, 
        label ,
        colors
        ...
        const { iconsOptions, setIconsOptions } = useSettingsStore();
        const isActive = iconsOptions === mode;
        
        return (
            <TouchableOpacity
                activeOpacity={0.7}
                onPress={() => setIconsOptions(mode)}
